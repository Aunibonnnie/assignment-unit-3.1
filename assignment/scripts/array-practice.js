...
let favoriteFoods = ['Pizza', 'Pasta', 'Sushi', 'Chocolate'];
...
let favoriteFoodsToPush = dessert;
favoriteFoods.push(favoriteFoodsToPush);
console.log('Added an dessert to end', favoriteFoods);
...
let favoriteFoodsToUnshift = entree;
favoriteFoods.unshift(favoriteFoodsToUnshift);
...
console.log('Removed the last color', removedColors);
...
removedColors = colors.shift();
console.log('Removed the first color', removedColors);
console.log('The colors are now', colors);
...
//concat() method
let colorfulGems2 = gems.concat(colors);
console.log(colorfulGems2);
